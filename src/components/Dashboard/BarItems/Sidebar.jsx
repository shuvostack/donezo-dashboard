import { FiGrid, FiCheckSquare, FiCalendar, FiBarChart2, FiUsers, FiSettings, FiHelpCircle, FiLogOut, FiX } from "react-icons/fi"; 
...
const Sidebar = ({ isOpen, onCloseSidebar }) => { 
  ...
  return (
    <>
      ...
      {/* sidebar container */}
      <div className={`fixed lg:sticky top-0 left-0 z-50 h-screen w-[260px] bg-[#F4F7F6] flex flex-col justify-between py-8 shadow-2xl lg:shadow-[2px_0_8px_rgba(0,0,0,0.02)] transition-transform duration-300 ease-in-out lg:translate-x-0 ${isOpen ? "translate-x-0" : "-translate-x-full"} lg:mt-5 lg:ml-4 lg:mb-5 lg:rounded-2xl`}>
        ...
        <div className="overflow-y-auto overflow-x-hidden">
          ...
          <div className="px-8 mb-12 flex items-center justify-between">
            ...
            {/* close icon */}
            <button onClick={onCloseSidebar} className="lg:hidden text-gray-500 hover:text-gray-900">
